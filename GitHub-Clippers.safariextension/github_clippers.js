...
var detectAndTapDeleteBranch = function() {
  ...
  var branchName = document.querySelectorAll(".head-ref span")[0].textContent
  if (branchName && settings.whitelist.length) {
    var branches = settings.repos.replace(/ /g, "").split(",")
